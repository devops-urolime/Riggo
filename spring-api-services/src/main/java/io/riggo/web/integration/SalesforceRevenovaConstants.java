...
public interface SalesforceRevenovaConstants {
    ...
    String[] POST_LOAD_LOAD_STOP_IGNORE_PROPERTIES = new String[]{"extSysId", "extSysTenantId", "name", "type", "stopNumber", "shippingReceivingHours", "expectedDateTime", "departureDateTime", "appointmentRequired", "appointmentTime", "stopStatus", "carrierStatus"};
